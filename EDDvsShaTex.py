...
y = []
y2 = []
csv_path = './csv/IN_resnet18_cifar10_4000epochs_ln20pc_test.csv'
...
train_x = []
train_y = []
csv_path = './csv/IN_resnet18_cifar10_4000epochs_ln20pc_train.csv'
data = pd.read_csv(csv_path)
data = data.values.tolist()
count = 0
sub = 0.0
...
Shapes = []
Textures = []
csv_path = './shape_texture_bias_csv/IN_res18_4000ep_cifar10_ln20pc.csv'
...
csv_path = './shape_texture_bias_csv/IN_res18_4000ep_cifar10_ln20pc1.csv'
data = pd.read_csv(csv_path, header=None)
data = data.values.tolist()
for i in range(int(len(data) / 2)):
    x2.append(i * 5 + 1005)
...
plt.axvline(x=12, ymin=0.02, ymax=0.43 * 1.5, c="black", linewidth=1.0)
plt.axvline(x=42, ymin=0.02, ymax=0.43 * 1.5, c="black", linewidth=1.0)
